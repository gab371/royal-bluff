  ...
  return (
    <P2PlayLobby
      ...
      classes={{
        ...
        input: "w-full px-4 py-3 rounded-2xl bg-zinc-950 dark:bg-zinc-950 border border-zinc-800 focus:border-amber-500 text-zinc-150 outline-none transition-all disabled:opacity-50",
        ...
        avatarItemSelected: "text-2xl p-1.5 rounded-xl transition-all flex items-center justify-center aspect-square bg-amber-500/20 border-2 border-amber-500 scale-110 shadow-[0_0_12px_rgba(245,158,11,0.3)]",
        ...
        joinInput: "w-1/3 px-4 py-3 rounded-2xl bg-zinc-950 dark:bg-zinc-950 border border-zinc-800 focus:border-amber-500 text-zinc-150 text-center outline-none transition-all font-mono tracking-wider",
